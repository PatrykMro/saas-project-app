...
// hanlde event of plan drop down changing
...
// call plan change handler so that that the plan is set correctly in the drop down when page loads
...
// function to handle the token received from Stripe and remove credit card fields
  stripeResponseHandler = function (status,response) {
    ...
    if (response.error) {
      ...
      show_error(response.console.error.message);
